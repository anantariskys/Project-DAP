...
const Hero = () => {
  return (
    <div className="z-0  flex justify-center items-center h-screen w-full md:mb-0 mb-36">
      <div className="h-2/4 relative w-5/6  blur-3xl ">
        <div className="md:absolute relative w-full h-[50rem] md:h-full bg-gradient-to-b from-[#A35ECD] via-[#23016D] to-[#35957E] blur-2xl md:bottom-0 bottom-48 "></div>
      </div>
