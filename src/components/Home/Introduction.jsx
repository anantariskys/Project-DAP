  ...
  return (
    <>
      <div className="w-5/6 mx-auto mb-28  ">
        <h1 className="md:text-5xl text-2xl font-extrabold text-center font-Poppins text-white md:mb-16 mb-2">Kode Editor</h1>
        <div className="flex md:flex-row flex-col  justify-start gap-14">
          ...
          <div className="flex flex-col font-Poppins text-white">
            <h2 className="md:text-3xl text-base font-extrabold md:mb-10 mb-2 md:mt-6 -mt-5">Berlatih langsung dari dalam browser</h2>
            <p className="md:text-2xl text-sm font-medium leading-relaxed text-left">
      ...
      <div className="w-5/6 mx-auto mb-28 ">
        <h1 className="md:text-5xl text-2xl font-extrabold text-center font-Poppins text-white  md:mb-16 mb-2">Blog</h1>
        <div className="flex md:flex-row-reverse flex-col  justify-start gap-14">
          <img src={Blog} className="rounded-2xl md:h-96 h-52 md:aspect-auto aspect-video md:object-none object-cover object-top" alt="" />
          <div className="flex flex-col font-Poppins text-white">
            <h2 className="md:text-3xl text-base font-extrabold md:mb-10 mb-2 md:mt-6 -mt-5 md:text-right">Segala Informasi Seputar Ngoding</h2>
            <p className="md:text-2xl text-sm font-medium leading-relaxed md:text-right">
      ...
      <div className="w-5/6 mx-auto mb-28  ">
        <h1 className="md:text-5xl text-2xl font-extrabold text-center font-Poppins text-white md:mb-16 mb-2">Sertifikat</h1>
        <div className="flex md:flex-row flex-col  justify-start gap-14">
          <img src={Sertifikat} className="rounded-2xl md:h-96 h-52 md:aspect-auto aspect-video md:object-none object-cover" alt="" />
          <div className="flex flex-col font-Poppins text-white">
            <h2 className="md:text-3xl text-base font-extrabold md:mb-10 mb-2 md:mt-6 -mt-5">Validasi Skill Kamu</h2>
            <p className="md:text-2xl text-sm font-medium leading-relaxed text-left">
      ...
      <div className="w-5/6 mx-auto mb-28  ">
        <h1 className="md:text-5xl text-2xl font-extrabold text-center font-Poppins text-white  md:mb-16 mb-2">Forum</h1>
        <div className="flex md:flex-row-reverse flex-col  justify-start gap-14">
          <img src={Forum} className="rounded-2xl md:h-96 h-52 md:aspect-auto aspect-video md:object-none object-cover object-top" alt="" />
          <div className="flex flex-col font-Poppins text-white">
            <h2 className="md:text-3xl text-base font-extrabold md:mb-10 mb-2 md:mt-6 -mt-5 md:text-right">Kesulitan? Jangan kuatir!</h2>
            <p className="md:text-2xl text-sm font-medium leading-relaxed md:text-right">
